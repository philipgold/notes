...
Our **AWS cheat sheets** were created to give you a bird’s eye view of the important AWS  services that you need to know by heart to be able to pass the different **AWS certification exams** such as the AWS Certified  Cloud Practitioner, AWS Certified Solutions Architect Associate, as well as the other Associate, Professional, and Specialty certification  exams. It’s presented mostly in bullet points to provide you with  easy-to-digest and easy-to-remember notes that will help you gain a  bettexr understanding of the different AWS services.



### **[AWS Overview](./aws-overview/README.md)**
...
- [AWS Five Pillars](./aws-overview/aws-well-architected-framework-five-pillars.md)
...
### [**AWS Compute Services**](./compute-services/README.md)
...
- [AWS Directory Service](./security-identity-services/directory-service.md)
...
- [AWS OpsWorks](./management-tools/opsworks.md)
...
- [Latency Routing vs Geoproximity Routing vs Geolocation Routing](./comparison-of-aws-services/latency-routing-vs-geoproximity-routing-vs-geolocation-routing.md)
